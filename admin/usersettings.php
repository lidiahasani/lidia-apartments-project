        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="roomsettings.php"><i class="fa fa-dashboard"></i>User Dashboard</a>
                    </li>
                ...
                <div class="col-md-12">
										...
										while($row = mysqli_fetch_array($result))
										{
											...
											$password = $row['password'];
												echo"<tr class='gradeC'>
													...
													<td><a href=userdel.php?userID=".$id ." <button class='btn btn-danger'> <i class='fa fa-edit' ></i> Delete</button></td>
												</tr>";										
										}
					...
					<div class="panel-body">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
										...
										<div class="modal-body">
                                            ...
                                            <input name="newpass"  class="form-control" placeholder="Enter Password">
											</div>
                                        </div>
						...
						if(isset($_POST['in']))
						{
							...
							{
							echo' <script language="javascript" type="text/javascript"> alert("Username and password Added") </script>';
							}
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input name="username" value="<?php echo $username; ?>" class="form-control" placeholder="Enter User name">
											</div>
										</div>
										<div class="modal-body">
                                            <div class="form-group">
                                            <label>Change Password</label>
                                            <input name="pass" value="<?php echo $password; ?>" class="form-control" placeholder="Enter Password">
											</div>
                                        </div>
